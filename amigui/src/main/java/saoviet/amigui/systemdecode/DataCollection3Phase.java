package saoviet.amigui.systemdecode;
...
public class DataCollection3Phase {
	 ...
	 */
	public DataCollection3Phase() {
		LoadForm();
		initialize();
	}

	public void LoadForm() {
		this.iactive = new ConnectionManagement();
	...
	private void initialize() {
		...
		frmDataCollection.setTitle("DATA COLLECTION 3 PHASE");
		...
		btnDisconnect.setSelectedIcon(new ImageIcon(DataCollection3Phase.class.getResource("/junit/runner/logo.gif")));
